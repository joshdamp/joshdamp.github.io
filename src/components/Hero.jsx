    ...
    <section id="hero" className="container mx-auto px-6 py-16 flex items-center justify-center relative">
      <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-6xl">
        <div className="md:w-1/2 flex justify-center mb-12 md:mb-0">
          <div className="profile-image-container">
            <img src="/images/firstpic.png" alt="Joshua Dampil" className="profile-image" />
            <img src="/images/Hexagon.png" alt="Hexagon Frame" className="hexagon-image" />
          </div>
        </div>
      ...
      <div className="hero-controls">
        <nav className="social-links" aria-label="Social media links">
          <a href="mailto:joshuadamps@gmail.com" className="social-link" title="Email">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
              <path d="M20,4H4C2.9,4,2,4.9,2,6v12c0,1.1,0.9,2,2,2h16c1.1,0,2-0.9,2-2V6C22,4.9,21.1,4,20,4z M20,8l-8,5L4,8V6l8,5l8-5V8z"/>
            </svg>
          </a>
          <a href="https://github.com/joshdamp" target="_blank" rel="noopener noreferrer" className="social-link" title="GitHub">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="https://www.linkedin.com/in/joshua-dampil123/" target="_blank" rel="noopener noreferrer" className="social-link" title="LinkedIn">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        ...
        <button id="chatbot-toggle-btn" className="chatbot-toggle-hero" type="button" title="Open chat" aria-label="Open chatbot">
